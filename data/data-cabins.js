import { supabaseUrl, supabase } from "@/supabase/supabase";
...
// Function to add all the sample data to the cabins_test table
export async function addSampleCabins() {
  try {
    for (const cabin of cabins) {
      ...
      if (error) {
        ...
        console.log("Cabin added successfully:", data);
      }
    }
  } catch (error) {
    console.error("Error adding sample cabins:", error);
  }
}
